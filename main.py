...
game.show_long_text("Astronaut bob let a bunch of cows in to space find and capture  all that you can",
    DialogLayout.CENTER)
game.show_long_text("Press a to shoot your beam", DialogLayout.CENTER)
...
def on_update_interval():
    ...
    if cowCount == 5:
        ...
        projectile = sprites.create_projectile_from_side(img("""
            ...
            55,
            0)
        projectile.set_position(2, randint(120, 75))
game.on_update_interval(1500, on_update_interval)

def on_update_interval2():
    global projectile
    projectile = sprites.create_projectile_from_side(asteroids[randint(0, len(asteroids) - 1)], -50, 0)
